	...
	<div class="bs-example bs-example-tabs">
		<div>
		    <ul id="myTab" class="nav nav-tabs" role="tablist">
		      <li class="active"><a href="#home" role="tab" data-toggle="tab"><i class="fa fa-gear"></i></a></li>
		      <li class=""><a href="#profile" role="tab" data-toggle="tab"><i class="fa fa-gear"></i> Masukan Kode</a></li>
		    </ul>
	    </div>
